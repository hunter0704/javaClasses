...
public class MethodWithReturnValue {
	public static void main(String[] args) {
		...
		//if String has more than 10 charecters-->String is large
		// other wise -->String is small
    ...
    Recap obj=new Recap();
    // int num  obj.sum(10,30); will give us compile error saying change the return type
